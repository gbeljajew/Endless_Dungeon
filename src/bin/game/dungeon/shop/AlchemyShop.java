 ...
 * @author gbeljajew
 */
public class AlchemyShop implements Shop
{
    ...
    {
        return GameLocale.getString("core.shop.name.alchemy");
    }
    ...
    {
        return GraphicResources.getMiskImage("core.shop.owner.alchemist");
    }
